...
//         <div
//           ref={containerRef}
//           className="relative w-full max-w-5xl mx-auto cursor-ew-resize select-none overflow-hidden"
...
//             <span className="text-[9px] uppercase tracking-[0.4em] text-white/70 bg-black/10 backdrop-blur-sm px-3 py-1.5 rounded-sm">
//               After
//             </span>
//           </div>
//           <div
...
//           </div>
//           <div
//             className="absolute top-0 bottom-0 w-[1px] bg-white/50 z-30"
...
//           <p className="text-gray-400 font-light italic tracking-wide text-xs">
...
export default function Comparison() {
  ...
  const handleMove = (event: React.MouseEvent | React.TouchEvent) => {
    ...
    // Get the X coordinate regardless of touch or mouse
    const x =
      "touches" in event
        ? event.touches[0].clientX
        : (event as React.MouseEvent).clientX;
    ...
    // Clamp values so it can hit 0 and 100 exactly
    ...
    <section className="bg-white py-6 md:py-24">
      <Container>
        ...
        <div
          ...
          onTouchMove={handleMove}
        >
          {/* AFTER IMAGE: Visible when slider is at 0% */}
          <img src="/After.png" alt="After" className="w-full h-auto block" />

          {/* BEFORE IMAGE: Visible when slider is at 100% */}
          <div
          ...
          {/* THE HANDLE: Disappears at the very edges for a clean look */}
          <div
